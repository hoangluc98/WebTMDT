                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="col-sm-3 col-xs-3">
                                <img class="img-responsive" style="height: 100px;width: 70px;" src="{{ asset(pare_url_file($product->options->avatar)) }}" />
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                <div class="pull-right"><span>{{ \Cart::subtotal() }}</span> VND</div>
                            </div>
                        </div>
                    </div>
                </div>
