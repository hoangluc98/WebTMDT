<div class="slider-area an-1 hm-1">
    <div class="bend niceties preview-2">
        <div id="ensign-nivoslider" class="slides"> 
            <img src="{{ asset('images\slide.png')}}" alt="" title="#slider-direction-1" style="height: 100%;width: 1920px;" />
            <img src="{{ asset('images\slide2.gif')}}" alt="" title="#slider-direction-2" style="height: 100%;width: 1920px;" />
        </div>
        <!-- direction 1 -->
