...
@section('content')
	<style>
		.rating .active{color: #fd9705 !important}
	</style>
			            ...
			            <tr>
			                ...
			                <td>
			                	...
			                	<ul style="padding-left: 15px;">
			                		...
			                		<li><span>{{ $product->pro_sale }} (%) VNĐ</span></li>
			                		<li>
			                			<span>Đánh giá: </span>
			                			<span class="rating">
			                				@for($i = 1 ; $i <= 5 ; $i++)
			                ...
			                <td>
			                	<img src="{{ asset(pare_url_file($product->pro_avatar)) }}" style="height: 100px; width: 100px;" alt="">
			                </td>
			                <td>
			                ...
			                <td>
			                	<a style="padding: 5px 10px;border: 1px solid #999;font-size: 12px;border-radius: 5px;" href="{{ route('admin.get.edit.product',$product->id) }}"><i class="fas fa-pen" style="font-size: 11px;"></i>Cập nhật</a>
			                	<a style="padding: 5px 10px;border: 1px solid #999;font-size: 12px;border-radius: 5px;" href="{{ route('admin.get.action.product',['delete',$product->id]) }}"><i class="fas fa-trash-alt" style="font-size: 11px;"></i>Xóa</a>
			                </td>
			            </tr>
		            @endforeach
	            @endif
