	        	...
	        	@if(isset($articles))
	        		@foreach($articles as $article)
			            <tr>
			                ...
			                <td>
			                	<img src="{{ asset(pare_url_file($article->a_avatar)) }}" style="height: 100px; width: 100px;" alt="">
			                </td>
			                ...
			                <td>
			                	<a style="padding: 5px 10px;border: 1px solid #999;font-size: 12px;border-radius: 5px;" href="{{ route('admin.get.edit.article',$article->id) }}"><i class="fas fa-pen" style="font-size: 11px;"></i>Cập nhật</a>
			                	<a style="padding: 5px 10px;border: 1px solid #999;font-size: 12px;border-radius: 5px;" href="{{ route('admin.get.action.article',['delete',$article->id]) }}"><i class="fas fa-trash-alt" style="font-size: 11px;"></i>Xóa</a>
			                </td>
			            </tr>
		            @endforeach
	            @endif
